...
(function() {
  var boardIsFull, buildBoard, collapseCells, generateTile, getBiggestNumber, getColumn, getRow, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, quoteToShow, randomCellIndices, randomInt, randomQuote, randomValue, restartGame, setColumn, setRow, showBoard,
      ...
      return function(e) {
        ...
        if (__indexOf.call(keys, key) >= 0) {
          ...
          if (moveIsValid(_this.board, newBoard)) {
            ...
            $("#random_quote").html(quoteToShow(getBiggestNumber(_this.board)));
